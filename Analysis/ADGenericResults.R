#==================================================================================================
# Title:                 Anaerobic Digester Calculation: Results Processing
...
library(ggplot2)
library(metR)
load("ADGenericResultsData.RData")
#--------------------------------------------------------------------------------------------------
...
customlabels             = c("Not Profitable","0%-2%","2%-4%","4%-6%","6%-8%","8%-10%","10%-12%",
                             "12%-14%","14%-16%","16%-18%")
#--------------------------------------------------------------------------------------------------
df                       = subset(dfbase,situation=="Anaerobic Lagoon 18C" & lifetime==30)
ggplot(df,aes(x=head,y=pcarbon,z=irr))+
     geom_contour_fill(aes(fill=after_stat(level)),breaks=breakscale)+
     ...
     xlab("Farm Size (Head)")+theme(legend.position="bottom")
...
#write.csv(df[c("usename","farmtype","head","irr","pcarbon","lifetime","situation","item")],
